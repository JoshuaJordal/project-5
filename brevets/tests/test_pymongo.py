...
def test_brevets_insert():
    ...
    assert(db.races.find_one({},{ "_id": 0 }) == {"open": '2021-01-01 00:00:00', "close": '2021-02-01 00:00:00', "km": '100', "miles": '60', "brevet": '100', "time": '2021-01-01 00:00:00'})
...
def test_brevets_retrieval():
    ...
    assert(db.races.find_one({},{ "_id": 0 }) == {"open": '2021-04-01 10:30:00', "close": '2021-05-01 10:30:00', "km": '350', "miles": '300', "brevet": '300', "time": '2021-03-01 12:30:00'})
