...
Usage:
Enter your brevet distance, start time, and control distances then hit submit. The form will be cleared and you information will be stored in the db. To see the calculations enter display and you will get all your times displayed on the page